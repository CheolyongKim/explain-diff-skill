...
- Use the Notion MCP tools to create a new page and return the URL of the new page. This requires a Notion MCP server configured separately with `codex mcp add`; this plugin does not bundle credentials or an MCP server.
